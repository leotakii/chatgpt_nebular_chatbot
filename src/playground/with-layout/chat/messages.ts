export const messages = [
  {
    text: 'Olá, estou aqui para lhe auxiliar na investigação de pessoas físicas e jurídicas.\nPara iniciar, digite Investigar. Para mais informações, digite Ajuda.',
    reply: false,
    date: new Date(),
    user: {
  ...
  /* exemplos de tipos possíveis de mensagem
  {
